...
function Home({posts}:Props) {
  ...
  return (
    <div className='max-w-7xl mx-auto'>
      ...
      <Header/>
      <div
        className='flex justify-between items-center bg-yellow-500 border-y border-black py-10 lg:py-0'
      >
        <div
        ...
        <img
        className='hidden md:inline-flex h-32 lg:h-full pr-5 '
        src='https://cdn3.iconfinder.com/data/icons/social-media-2253/17/Vector-512.png'
        />
      </div>
